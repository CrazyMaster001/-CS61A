...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    assert player_score > 0 and opponent_score > 0, 'Invalid'
    one = player_score % 10
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    temp_score = player_score + turn_score
    after_sus = sus_points(temp_score)
    final_score = boar_brawl(after_sus,opponent_score)
    return final_score
    # END PROBLEM 4
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    boar_score = boar_brawl(score,opponent_score)
    next_score = score + boar_score
    next_score = sus_points(next_score)
    addition = next_score - score
